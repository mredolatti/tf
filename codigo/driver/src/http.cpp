...
Request::Builder& Request::Builder::method(Method m)
{
    method_ = m;
    return *this;
}
Request::Builder& Request::Builder::body(std::string b)
{
    body_ = std::move(b);
    return *this;
}
Request::Builder& Request::Builder::uri(std::string u)
{
    uri_ = std::move(u);
    return *this;
}
Request::Builder& Request::Builder::headers(Headers h)
{
    headers_ = std::move(h);
    return *this;
}
Request::Builder& Request::Builder::tls(tls::Config c)
{
    tls_conf_ = std::move(c);
    return *this;
}
...
const std::string& Request::url() const { return uri_; }
...
Response::Builder& Response::Builder::code(int code)
{
    code_ = code;
    return *this;
}
Response::Builder& Response::Builder::add_header(std::string name, std::string value)
{
    headers_[name] = std::move(value);
    return *this;
}
Response::Builder& Response::Builder::body_append(std::string data)
{
    body_builder_ << data;
    return *this;
}
Response::Builder& Response::Builder::body_append(const char *data)
{
    body_builder_ << data;
    return *this;
}
Response::Builder& Response::Builder::body_append(const char *data, std::size_t len)
{
    body_builder_ << std::string{data, len};
    return *this;
}

Response Response::Builder::build() { return Response{code_, body_builder_.str(), std::move(headers_)}; }
...
const Headers& Response::headears() const { return headers_; }
