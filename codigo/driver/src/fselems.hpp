...
class FSEFile : public FSElem
{
  public:
    ...
    FSEFile(std::string name, std::string_view org, std::string_view server, std::string_view ref,
...
class FSELink : public FSElem
{
  public:
    ...
    FSELink(std::string_view id, std::string_view name, std::string_view org_name, std::string_view server_id,
            std::string_view ref);
    std::size_t size_bytes() const override;
    void accept(FSElemVisitor&) const override;
