...
type UserManagementClient interface {
	...
	ListUsers(ctx context.Context, in *Empty, opts ...grpc.CallOption) (UserManagement_ListUsersClient, error)
}
...
func (c *userManagementClient) ListUsers(ctx context.Context, in *Empty, opts ...grpc.CallOption) (UserManagement_ListUsersClient, error) {
	stream, err := c.cc.NewStream(ctx, &UserManagement_ServiceDesc.Streams[0], "/usermgmt.UserManagement/ListUsers", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *userManagementListUsersClient) Recv() (*User, error) {
	m := new(User)
...
type UserManagementServer interface {
	...
	ListUsers(*Empty, UserManagement_ListUsersServer) error
...
func (UnimplementedUserManagementServer) ListUsers(*Empty, UserManagement_ListUsersServer) error {
...
func (x *userManagementListUsersServer) Send(m *User) error {
